        ...
        >
          <div className="grid grid-cols-2 gap-4 md:gap-8 mb-8 pb-6 border-b border-gray-200">
            <div className="flex flex-col items-center sm:items-start">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-fluxiqo to-fluxiqo-light flex items-center justify-center text-white font-bold tracking-tight text-xl mb-3 shadow-sm shadow-fluxiqo/20">
                F
              </div>
